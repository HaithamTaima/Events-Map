...
class BuildindingController extends Controller
{
    public function add_building(Request $request){
        ...
        $building->event_name =  $request->input('event_name');
        $building->event_count =  $request->input('event_count');
        $building->event_category =  $request->input('event_category');
    ...
    public function add_new_citizen(Request $request){
        ...
        return redirect('view_event_details');
